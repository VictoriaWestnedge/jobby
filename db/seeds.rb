...
user4 = User.create!(nickname: "Andres", email: "andres@gmail.com", password: "123456")
...
user5 = User.create!(nickname: "Cecilia", email: "cecilia@gmail.com", password: "123456")
...
job2 = Job.create!(name: "Babysitter needed", description: "I am looking for a babysitter to look after my 4 year old girl", category: "Babysitting", address: "Blest Gana 5888", city: "Santiago", qty_hour: 4, price_per_hour: 30, start_date: Date.new(2023,3,15), end_date: Date.new(2023,3,15), start_time: Time.now.strftime("19:00:00"), end_time: Time.now.strftime("23:00:00"), user: user1)
...
job3 = Job.create!(name: "Delivery of packages", description: "Looking for someone that can deliver some heavy boxes to my office", category: "Deliveries", address: "Av. Los Pajaritos 3271", city: "Santiago", qty_hour: 2, price_per_hour: 20, start_date: Date.new(2023,3,20), end_date: Date.new(2023,3,20), start_time: Time.now.strftime("16:00:00"), end_time: Time.now.strftime("18:00:00"), user: user3)
...
job4 = Job.create!(name: "Petsitting my dog", description: "Looking for someone to look after my dog Leia for the weekend", category: "Petsitting", address: "Av. Jorge Montt 11700", city: "Talcahuano", qty_hour: 12, price_per_hour: 10, start_date: Date.new(2023,3,18), end_date: Date.new(2023,3,19), start_time: Time.now.strftime("20:00:00"), end_time: Time.now.strftime("08:00:00"), user: user3)
...
job8 = Job.create!(name: "Babysitting my son", description: "Looking for someone to look after my baby Alexander", category: "Babysitting", address: "Ramón Cruz Montt 2895", city: "Santiago", qty_hour: 12, price_per_hour: 10, start_date: Date.new(2023,3,18), end_date: Date.new(2023,3,19), start_time: Time.now.strftime("20:00:00"), end_time: Time.now.strftime("08:00:00"), user: user4)
